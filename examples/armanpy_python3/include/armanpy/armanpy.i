...
INIT_ARMA_CAPSULE( arma::Col< long long unsigned int >         )
...
INIT_ARMA_CAPSULE( arma::Row< long long unsigned int >         )
...
INIT_ARMA_CAPSULE( arma::Mat< long long unsigned int >         )
...
INIT_ARMA_CAPSULE( arma::Cube< long long unsigned int >         )
...
INIT_ARMA_BSPTR_CAPSULE( arma::Col< long long unsigned int >         )
...
INIT_ARMA_BSPTR_CAPSULE( arma::Row< long long unsigned int >         )
...
INIT_ARMA_BSPTR_CAPSULE( arma::Mat< long long unsigned int >         )
...
INIT_ARMA_BSPTR_CAPSULE( arma::Cube< long long unsigned int >         )
