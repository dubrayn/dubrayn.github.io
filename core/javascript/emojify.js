   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            var defaultConfig = {
                blacklist: {
                    'ids': [],
                    'classes': ['no-emojify', 'remark-code-line'],
                    'elements': ['script', 'textarea', 'a', 'pre', 'code']
                },
                tag_type: null,
                only_crawl_id: null,
                img_dir: 'core/javascript/emojis',
                ...
                if(typeof win.document.createTreeWalker !== 'undefined') {
                    var nodeIterator = win.document.createTreeWalker(
                        ...
                        function(node) {
                            ...
                            if((defaultConfig.blacklist.elements.indexOf(node.tagName) >= 0) || node.tagName === "svg" || (defaultConfig.blacklist.classes.indexOf(node.className) >= 0)) {
